...
export const views = {
  ...
  coachDashboard: {
    ...
    nextStudentTournament: "Your students' next competition",
    inactiveStrip: "{{count}} students without training for {{days}}+ days",
    inactiveStrip_one: "{{count}} student without training for {{days}}+ days",
