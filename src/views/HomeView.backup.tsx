    ...
    <div className="flex flex-col h-full bg-[#fcfdfe] px-5 pb-24 pt-[calc(env(safe-area-inset-top)+0.5rem)]">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm flex items-stretch flex-1 overflow-hidden">
          ...
          >
            <p className="text-[22px] font-black text-[#0a3a2a] leading-none">{monthlyTotal}</p>
            <span className="text-[7px] font-bold text-gray-400 uppercase mt-0.5 tracking-wide whitespace-nowrap">{t('home.month')}</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] font-black text-[#725b00]/50 mt-0.5">x̄₁₄</span>
          </button>

          <div className="w-[1px] bg-gray-100 self-stretch shrink-0" />

          {/* 3. Wykres + etykiety */}
          <div className="flex-1 flex items-center justify-center px-2 py-2 min-w-0">
            {recentScores.length >= 2 ? (() => {
              const W = 90, H = 42, pad = 5;
                ...
                <div className="flex items-center gap-2 w-full justify-center">
                  <svg width={W} height={H} viewBox={`0 0 ${W} ${H}`} className="shrink-0">
                    ...
                    {pts.map((p, i) => {
                      ...
                      const color = isMax ? '#22c55e' : isMin ? '#ef4444' : '#0a3a2a';
                  ...
                  <div className="flex flex-col gap-[5px] shrink-0">
                    ...
                    <span className="flex items-center gap-1 text-[9px] font-black text-gray-400 leading-none">
                      <span className="w-2 h-2 rounded-full bg-gray-300 shrink-0 inline-block" />{lastS}
                    </span>
                  </div>
                </div>
              );
        ...
        >
          <p className="text-[22px] font-black text-[#725b00] leading-none">{realLastSession ? realLastSession.score : '--'}</p>
          <span className="text-[7px] font-bold text-[#725b00]/70 leading-none mt-0.5 whitespace-nowrap block">{realLastSession ? realLastSession.distance : '--'}</span>
          <span className="text-[8px] font-bold text-[#725b00]/60 leading-none mt-0.5 whitespace-nowrap block">
            {realLastSession
              ? (() => {
        ...
        <div className="mt-1 grid grid-cols-2 gap-2">
          ...
          <div
            ...
            className={`rounded-[24px] border flex flex-col justify-between p-3 cursor-pointer active:scale-[0.98] transition-all relative overflow-hidden min-h-[96px] ${
              hasAnyBattle
                ? 'bg-gradient-to-br from-fuchsia-700 to-fuchsia-900 border-fuchsia-500'
          ...
          >
            ...
            <span className={`text-[7px] font-black uppercase tracking-widest leading-none ${hasAnyBattle ? 'text-fuchsia-200' : 'text-indigo-200'}`}>
              Multiplayer Arena
            </span>
            <div className="relative z-10">
              ...
              {hasAnyBattle && (
                <div className="flex items-center gap-1 mt-0.5">
                  ...
                  <span className="text-[7px] font-bold text-white/50 truncate">
                    {allActiveBattles.filter(b => b.mode === 'CLUB').length > 0 && `${allActiveBattles.filter(b => b.mode === 'CLUB').length}kl`}
                    {allActiveBattles.filter(b => b.mode === 'CLUB').length > 0 && allActiveBattles.filter(b => b.mode === 'WORLD').length > 0 && ' · '}
                    {allActiveBattles.filter(b => b.mode === 'WORLD').length > 0 && `${allActiveBattles.filter(b => b.mode === 'WORLD').length}wr`}
                  </span>
                </div>
              )}
            </div>
          ...
          <button
            ...
            className="rounded-[24px] border border-gray-100 bg-white shadow-sm flex flex-col justify-between p-3 active:scale-[0.98] transition-all min-h-[96px] text-left"
          >
            <span className="text-[7px] font-black text-gray-400 uppercase tracking-widest leading-none">{t('home.archerRanking')}</span>
            <div className="flex items-center gap-2 mt-1">
              ...
              <div className="flex-1 min-w-0">
                <span
                  className="text-[8px] font-black px-1.5 py-[2px] rounded inline-block mb-1"
                ...
                <div className="w-full h-1 bg-gray-100 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${rankProgress}%`,
                      background: userLevel >= 9
                        ? `linear-gradient(90deg, ${userRankColor}, #fff5a0)`
                        : userRankColor
                    }}
                  />
                </div>
            ...
            <p className="text-[7px] font-bold text-gray-400 leading-none mt-1">
        ...
        {/* AI COACH */}
        <div className="p-3 bg-[#0a3a2a] rounded-[24px] flex gap-3 items-center shadow-lg relative overflow-hidden mt-1">
          ...
          <div className="flex-1 relative z-10 pr-2">
            <span className="font-black text-[#fed33e] uppercase text-[8px] tracking-widest block mb-0.5">{t('home.aiCoach')}</span>
            <p className="text-[11px] text-white font-medium leading-snug italic">"{aiAdvice}"</p>
          </div>
        </div>

        {/* BUILD TIMESTAMP */}
        <div className="text-center mt-1">
          <span className="text-[9px] text-gray-300 tracking-wide">build: 17.04.2026 · 10:54</span>
        </div>
            ...
            <div className="overflow-y-auto flex-1 px-6 pb-4 space-y-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-100 p-3 shadow-sm">
                    <span className="material-symbols-outlined text-fuchsia-400 text-[20px] block mb-1">public</span>
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1">World</p>
                    <p className="text-xl font-black text-[#0a3a2a]">{allActiveBattles.filter(b => b.mode === 'WORLD').length}</p>
                    <span className="text-[8px] font-bold text-gray-300">{t('home.active')}</span>
                  </div>
                </div>
                <button
